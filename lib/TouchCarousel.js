...
var TouchCarousel = function (_React$PureComponent) {
  ...
  function TouchCarousel(props) {
    ...
    _this.resetAutoplayTimer = function () {
      _this.stopAutoplay();
      _this.autoplayIfEnabled();
    };
  ...
  _createClass(TouchCarousel, [{
    ...
    value: function getComputedCursor() {
      var _props = this.props,
          ...
          maxCursorOffset = _props.maxCursorOffset;
      ...
      if (!loop) {
        computedCursor = (0, _utils.clamp)(computedCursor, 1 - cardCount + maxCursorOffset, 0);
